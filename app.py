...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        import logging; logging.getLogger("devos").warning("durable capabilities: %s", _e)
    try:
...
from api.routes import ssh_terminal
from api.routes import ssh_inspect
from api.routes import ssh_diagnostics
...
app.include_router(ssh_terminal.router, prefix="/api/ssh/terminal", tags=["ssh-terminal"])
app.include_router(ssh_inspect.router, prefix="/api/ssh", tags=["ssh-inspect"])
app.include_router(ssh_diagnostics.router, prefix="/api/ssh", tags=["ssh-diagnostics"])
